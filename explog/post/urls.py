...
from .views import PostListAPIView, PostDetailAPIView, PostReplyAPIView, PostReplyUpdateAPIView, PostTextAPIView, \
    PostPathAPIView, PostPhotolistView, \
...
urlpatterns = [
    ...
    url(r'^path/$', PostPathCreateAPIView.as_view(), name='post_path_create'),
